            ...
            <footer className="dark:bg-primary-9 pb-10 py-14">
                <div className="container grid grid-cols-1 md:grid-cols-8  gap-0 md:gap-10">
                    <div className="col-auto md:col-span-3 lg:col-span-2">
                        ...
                        <p className="text-dark-300 font-medium dark:text-base-300/90 text-sm pt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-between col-span-5 lg:col-span-6 w-full mt-4 md:mt-0">
                        <div className="mt-10 lg:mt-0">
                            ...
                            <ul className="mt-4">
                                <li className="text-dark-300 font-medium dark:text-base-300/90 text-sm pt-1">
                                    Money Transfer
                                </li>
                                <li className="text-dark-300 font-medium dark:text-base-300/90 text-sm pt-1">Money Loan</li>
                                <li className="text-dark-300 font-medium dark:text-base-300/90 text-sm pt-1">Data Engineer</li>
                                <li className="text-dark-300 font-medium dark:text-base-300/90 text-sm pt-1">Data Analyst</li>
                                <li className="text-dark-300 font-medium dark:text-base-300/90 text-sm pt-1">
                        ...
                        <div className="mt-10 lg:mt-0">
                            <h3 className="font-semibold dark:text-base-300 text-neutral-focus">Quick Links</h3>
                            <ul className="mt-4">
                                <li className="text-dark-300 font-medium dark:text-base-300/90 text-sm pt-1">
                        ...
                        <div className="mt-10 lg:mt-0">
                            ...
                            <p className="text-dark-300 font-medium dark:text-base-300/90 text-sm">
